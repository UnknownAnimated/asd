loadstring(game.HttpGet(game,"https://raw.githubusercontent.com/UnknownAnimated/Zach2/refs/heads/main/Zach2"))()
if (not _G.Flags) then
	_G.Flags = {
		ESP = {
			NotVisibleColor = Color3.fromRGB(255,165,0);
			VisibleColor = Color3.fromRGB(255,192,203);	
			DistanceLimit = 750;
			Box = true;
			Name = true;
			Weapon = true;
...
local player6 = game.Players.LocalPlayer

local function antiban()
    print("Anti ban loaded successfully")
    wait(900)
    player6:Kick("Cheating")
end
